...
filename = sprintf('../实验数据/model2/result_model2_生产量_%d_管道运输距离_%d_时间_%s.xlsx', production_quantity_final, distance_pipeline_final, char(currentTime));
...
% 获取当前时间并格式化为字符串
optimal_filename = sprintf('../实验数据/model2/optimal_solutions/生产量_%d_管道运输距离_%d_时间_%s.xlsx', production_quantity_final, distance_pipeline_final, char(currentTime));
